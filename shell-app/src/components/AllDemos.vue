  ...
  <div class="all-demos-container">
    ...
    <section class="demo-section demo-one-section">
      ...
      <div class="demo-controls demo-one-controls">
        ...
        <div class="control-buttons">
          ...
          <button @click="clearDemoOne" class="btn btn-secondary">🗑️ Clear</button>
        </div>
      </div>
    ...
    <section class="demo-section demo-two-section">
      ...
      <div class="demo-controls demo-two-controls">
        <div class="control-group">
          <label>Text:</label>
          <input v-model="demoTwoText" type="text" placeholder="Enter text" class="text-input">
          <button @click="addTextToTwo" class="btn btn-primary">➕ Add Text</button>
        </div>
        <div class="control-group">
          <label>Image URL:</label>
          <input v-model="demoTwoImageUrl" type="text" placeholder="Image URL" class="text-input">
          <button @click="addImageToTwo" class="btn btn-success" :disabled="isLoadingImage">
            {{ isLoadingImage ? '⏳ Loading...' : '🖼️ Add Image' }}
          </button>
        </div>
        <div class="control-buttons">
          <button @click="clearDemoTwo" class="btn btn-secondary">🗑️ Clear</button>
        </div>
      </div>
    ...
    <section class="demo-section demo-three-section">
      ...
      <div class="demo-controls demo-three-controls">
        ...
        <div class="control-group">
          ...
          <input v-model="brushWidth" type="range" min="1" max="20" class="range-input">
        ...
        <div class="control-buttons">
          <button @click="clearDemoThree" class="btn btn-secondary">🗑️ Clear</button>
        </div>
      </div>
...
const resetAllDemos = async () => {
  ...
  setTimeout(() => {
    // Reset Demo One
    if (demoOneCanvas && demoOneModule) {
      demoOneModule.addRectangle(demoOneCanvas, { left: 50, top: 50, fill: demoOneColor.value })
      demoOneModule.addCircle(demoOneCanvas, { left: 200, top: 100, fill: '#6AAAEB' })
      demoOneModule.addTriangle(demoOneCanvas, { left: 350, top: 80, fill: '#031F3C' })
    }
...
const addImageToTwo = async () => {
  if (demoTwoCanvas && demoTwoModule && demoTwoImageUrl.value.trim() && !isLoadingImage.value) {
